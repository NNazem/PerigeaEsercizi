...
public class InvestitoreSafe implements Investitore{
    ...
    public InvestitoreSafe(String codiceAlfanumerico) {
        settoriInvestiti = new LinkedList<>();
        settoriInvestiti.add(Argomento.BOND);
        settoriInvestiti.add(Argomento.STOCK);
        settoriInvestiti.add(Argomento.COMMODOTIES);
    ...
    public void update(Notizia notizia){
        if(notizia.priorità >= 4 && notizia.isPositiva && settoriInvestiti.contains(notizia.argomento)){
            effettuaInvestimento();
        }else if(notizia.priorità >= 2 && !notizia.isPositiva && settoriInvestiti.contains(notizia.argomento)){
            effettuaPrelievo();
        }
    }
